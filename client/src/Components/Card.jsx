...
const Card = ({ _id, name, prompt, photo }) => {
    return ( 
        ...
        hover:shadow-cardhover card w-[400px] h-[400px]'>
            ...
            m-2 p-4 rounded-md'>
                <p className='text-white text-sm overlfow-y-auto
                '>{prompt}</p>
                ...
                gap-2'>
                    <div className='flex items-center gap-2'>
                        ...
                        object-cover bg-green-700 flex justify-center
                    ...
                    _id,photo)} className="outline-none bg-transaprent
                    border-none">
                        <img src={download} alt="download" className='
                        w-6 h-6 object-contain invert' />
                    </button>
                </div>
            </div>
        </div>
